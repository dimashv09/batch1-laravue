...
<div id="controller">
            ...
            <div class="card-header">
                  <!-- ngga bisa detail -->
                <a href="#" @click="addData()" class="btn btn-primary pull-right">Create New Anggota</a>
            			...
            			<form :action="actionUrl" method="post" autocomplete="off" @submit="submitForm($event, data.id)">
                			...
                			<div class="modal-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <input type="number" name="phone_number" :value="data.phone_number" class="form-control" placeholder="Input Nomor Telepon" required="">
				                </div>
				                <div class="form-group">
				                    <label>Alamat</label>
				                    <input type="text" name="address" :value="data.address" class="form-control" placeholder="Input Alamat" required="">
				                </div>
                			</div>
...
<script>
	var actionUrl = '{{ url('anggota')}}';
	var apiUrl = '{{ url('api/anggota')}}';
