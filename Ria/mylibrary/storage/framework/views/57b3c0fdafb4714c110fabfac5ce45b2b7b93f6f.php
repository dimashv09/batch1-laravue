...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>My</b>Library</a>
    </div>
    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="Full Name" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>
      ...
      <a href="<?php echo e(('views/auth/passwords/login.blade.php')); ?>" class="text-center">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
...
<?php /**PATH C:\xampp\htdocs\laravue\library\resources\views/auth/register.blade.php ENDPATH**/ ?>