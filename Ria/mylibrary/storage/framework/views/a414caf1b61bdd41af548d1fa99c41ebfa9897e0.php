    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url(('members'))); ?>"class="nav-link <?php echo e(request()->is('members') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url(('catalogs'))); ?>"class="nav-link <?php echo e(request()->is('catalogs') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url(('books'))); ?>"class="nav-link <?php echo e(request()->is('books') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url(('authors'))); ?>"class="nav-link <?php echo e(request()->is('autors') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url(('publishers'))); ?>"class="nav-link <?php echo e(request()->is('publishers') ? 'active' : ''); ?>">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0"><?php echo $__env->yieldContent('header'); ?></h1>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
</html><?php /**PATH C:\xampp\htdocs\laravue\library\resources\views/layouts/admin.blade.php ENDPATH**/ ?>