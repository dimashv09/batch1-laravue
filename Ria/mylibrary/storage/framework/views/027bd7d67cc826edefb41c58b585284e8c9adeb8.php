...
<div class="card-tools">
    <a href="<?php echo e(url('authors/create')); ?>" class="btn btn-sm btn-primary pull-left">Create New Author</a>
...
<td class="text-center"><?php echo e(date('H:i:s - d M y', strtotime($author->updated_at))); ?></td>
<td class="text-center">
    <a href="<?php echo e(url('authors/'.$author->id.'/edit')); ?>" class="btn btn-warning btn-sm">Edit</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravue\library\resources\views/admin/author/index.blade.php ENDPATH**/ ?>