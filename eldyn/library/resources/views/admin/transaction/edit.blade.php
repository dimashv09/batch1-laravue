...
@section('wrapper-title', 'Transaction - Edit')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-12 col-md-8 d-flex flex-column flex-md-row px-0">
                                    <div class="d-flex align-items-center w-100 px-0">
                                        <div class="col-12 row">
                                            <input type="date" name="date_start" class="form-control col-9 @error('date_start') is-invalid @enderror" value="{{ $transaction->date_start }}">
                                    ...
                                    <div class="d-flex align-items-center w-100 px-0 ml-md-4">
                                        <div class="col-12 row">
                                            <input type="date" name="date_end" class="form-control col-9 @error('date_end') is-invalid @enderror" value="{{ $transaction->date_end }}">
                                            <i class="far fa-calendar-alt ml-3 text-xl col"></i>
                                        </div>
                                        @error('date_end')
                                        <p class="text-danger mt-1 col-12">{{ $message }}</p>
                            ...
                            <div class="row mb-4">
                                ...
                                @foreach ($details as $detail)
                                    ...
                                    <option value="{{ $book->id }}" class="text-black" {{ $book->id == $detail->book_id ? 'selected' : '' }}>{{ $book->title }}</option>
                                    @endforeach
                                @endforeach
                                </select>
                                @error('books')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="status" id="returned" value="1" {{ $transaction->status ? 'checked' : '' }}>
                                        <label class="form-check-label" for="returned">
                                            Returned
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="noReturned" value="0" {{ !$transaction->status ? 'checked' : '' }}>
