<html moznomarginboxes mozdisallowselectonprint>
<head>
	...
	<style type="text/css">
		...
		.content .transaction-table .sell_price {
			/* text-align: right; */
			 width: 65px;
			 text-align: right; 
		}	

		.content .transaction-table .final_price {
			 text-align: right; 
		}	
...
<body>
	<div class="content">
		...
		<div class="separatte-line" style="border:-top: 1-px dashesd #000;heightL 1px;margin-bottom: 5px"></div>
		...
		<div class="transaction">
			<table class="transaction-table" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="qty" style="text-align: ceneter">{{ $item->qty }}</td>
