							...
							<div class="card-body">
								<div class="col-md-12">
									<div class="mb-4 text-center">
										<h4 class="fw-bold">INPUT PRODUCT</h4>
									</div>
								</div>
							...
							<div class="card-body">
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											<td class="text-end fw-bold" colspan="4" style="background-color: #e6e6e7;">TOTAL</td>
