                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        ...
                                        <input v-model="search" type="text" class="form-control" placeholder="search by role name...">
...
<script>
	...
	//import referensi reactive from vue
	import { ref } from 'vue';

	//import inertia adapter
	import { Inertia } from '@inertiajs/inertia';

    //import sweet alert2 from vue
    ...
    export default {
		...
		setup() {
			//define state search with referensi reactive
			const search = ref('' || (new URL(document.location)).searchParams.get('q'));

			//define method serach
			const handleSearch = () => {
