							...
							<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<div class="mb-3">
												...
												<input type="date" v-model="end_date" class="form-control"  :class="{ 'is-invalid': errors.end_date }">
											</div>
										...
										<div class="col-md-2">
											<div class="mb-3">
												...
												<button class="btn btn-purple btn-md border-0 shadow w-100"><i class="fa fa-filter"></i> FILTER</button>
											</div>
										</div>
									</div>
								</form>
								...
								<div v-if="sales">
									...
									<div class="export text-end mb-3">
										<a :href="`/apps/sales/export?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-success btn-md border-0 shadow me-3"><i class="fa fa-file"></i> EXCEL</a>
										<a :href="`/apps/sales/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-secondary btn-md btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
									</div>
