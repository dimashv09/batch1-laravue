	...
	<nav class="navbar navbar-expand-lg navbar-dark mb-5 px-5">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav ms-auto">
				...
				<a class="nav-item nav-link active" href="index.php">Pengarang</a>
				...
				<table class="table table-bordered border-light table-striped table-hover text-center">
					...
					<tbody>
						...
						while ($data_pengarang = mysqli_fetch_assoc($pengarang)) {
							...
							echo "<td><a href='edit.php?id_pengarang=$data_pengarang[id_pengarang]' class='btn btn-warning btn-aksi'>Edit</a> <a href='delete.php?id_pengarang=$data_pengarang[id_pengarang]' class='btn btn-danger '>Delete</a></td>";
							"</tr>";
							$no++;
						}
						?>
