	...
	<div class="container">
		<div class="card">
			<div class="card-body">
				...
				<a class="btn btn-outline-success" href="create.php">Add New Pengarang</a><br><br>
				...
				<table class="table" width="80%" border="1">
					...
					while ($pengarang_data = mysqli_fetch_array($pengarang)) {
						...
						echo "<td><a class='btn btn-info btn-sm' href='update.php?id_pengarang=$pengarang_data[id_pengarang]'>Edit</a> | <a class='btn btn-warning btn-sm' href='delete.php?id_pengarang=$pengarang_data[id_pengarang]'>Delete</a></td></tr>";
					}
