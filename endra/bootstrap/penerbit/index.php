	...
	<div class="container">
		<div class="card">
			<div class="card-body">
				...
				<a class="btn btn-outline-success" href="create.php">Create New Penerbit</a><br><br>
				...
				<table class="table" width="80%" border="1">
					...
					while ($penerbit_data = mysqli_fetch_array($penerbit)) {
						...
						echo "<td><a class='btn btn-info btn-sm' href='update.php?id_penerbit=$penerbit_data[id_penerbit]'>Edit</a> | <a class='btn btn-warning btn-sm' href='delete.php?id_penerbit=$penerbit_data[id_penerbit]'>Delete</a></td></tr>";
					}
					?>
				</table>
			</div>
