...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2022 at 02:32 PM
...
INSERT INTO `tb_obat` (`id_obat`, `nama_obat`, `ket_obat`, `qty_stock`) VALUES
('01', 'Paramex', 'Pusing', 95),
('02', 'Paracetamol', 'Obat demam', 23),
('03', 'panadol', 'Pusing', 45),
('04', 'Hypo', 'Jantung', 34),
('05', 'Paramex', 'Pusing', 23),
('06', 'Paracetamol', 'Obat demam', 43),
('07', 'panadol', 'Pusing', 56),
('08', 'Hypo', 'Jantung', 34),
('09', 'panadol', 'Pusing', 21),
('10', 'Bodrex', 'sakit kepala', 99);
...
INSERT INTO `tb_pasien` (`id_pasien`, `nomer_identitas`, `nama_pasien`, `umur_pasien`, `jenis_kelamin`, `alamat`, `no_telepon`) VALUES
('01', '1000', 'Yukimura', 21, 'Laki Laki', 'Jatim', '08xxxxxx'),
('02', '1001', 'Neko', 20, 'perempuan', 'Jabar', '08xxxxxx'),
('03', '1003', 'Kumi', 39, 'Laki Laki', 'Jatim', '08xxxxxx'),
('04', '1004', 'Usagi', 40, 'perempuan', 'Jabar', '08xxxxxx'),
('05', '1005', 'Yukimura', 12, 'Laki Laki', 'Jatim', '08xxxxxx'),
('06', '1006', 'Neko', 32, 'perempuan', 'Jabar', '08xxxxxx'),
('07', '1007', 'Kumi', 23, 'Laki Laki', 'Jatim', '08xxxxxx'),
('08', '1008', 'Usagi', 18, 'perempuan', 'Jabar', '08xxxxxx'),
('09', '1009', 'Kumi', 19, 'Laki Laki', 'Jatim', '08xxxxxx'),
('10', '1010', 'Usagi', 20, 'perempuan', 'Jabar', '08xxxxxx');
...
('05', '05', 'Sakit', '05', '05', 'sakit keras', '05', '2022-11-01'),
