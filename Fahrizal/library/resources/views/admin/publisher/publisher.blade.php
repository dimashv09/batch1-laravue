                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" width: 10px text-right">
                                <a href="#" @click="editData( {{$publisher}} )" class="btn btn-warning btn-xs">Edit</a>
                                <a href="#" @click="deleteData({{ $publisher->id }})"class="btn btn-danger btn-xs">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
			...
			<div class="modal-content">
				<form method="post" :action="actionUrl" autocomplate="off">
					<div class="modal-header">
						<h4 class="modal-tittle">Publisher</h4>
		...
		methods: {
			...
			deleteData(id){
				...
				if(confirm("Are You Sure ?")) {
					axios.post(this.actionUrl,{_method:'DELETE'}).thend(response=>{
						location.reload();
					});
				}
