    ...
    $(function() {
        ...
        var donutData = {
            ...
            datasets: [{
                ...
                backgroundColor: ['#f56954', '#00a65a', '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de', '#98AFC7', '#0000A0', '#52D017', '#FFFF00', '#FF00FF', '#893BFF', '#C11B17', '#659EC7' ],
            }]
        }
        var donutOptions = {
        ...
        var pieData = {
            ...
            datasets: [{
                ...
                backgroundColor: [ '#00a65a', '#f39c12', '#f56954', '#00c0ef', '#3c8dbc', '#d2d6de',  '#98AFC7', '#0000A0', '#52D017', '#FFFF00', '#FF00FF', '#893BFF', '#C11B17', '#659EC7'],
            }]
        }
        var pieOptions = {
            maintainAspectRatio: false,
