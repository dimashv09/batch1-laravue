...
@section('subtitle', 'Katalog Baru')
@section('content-title', 'Katalog Baru' )
    ...
    <div class="col-md-8 col-sm-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Registrasi Katalog</h3>
            </div>
        <!-- /.card-header -->
        <!-- form start -->
            <form action="{{url('catalog')}}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputNama" placeholder="Masukan nama katalog baru" required>
                        @error('name')
