...
INSERT INTO `customer` (`id`, `nama_pelanggan`, `umur`) VALUES
(1, 'M riko', 23),
(2, 'm rudi', 20),
(3, 'sucia febri', 24),
(4, 'iga auliani', 56),
...
CREATE TABLE `detail_customer` (
  ...
  `jenis_penyakit` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `detail_customer`
--
...
--
-- AUTO_INCREMENT for table `detail_customer`
--
ALTER TABLE `detail_customer`
...
--
-- Constraints for table `detail_customer`
--
ALTER TABLE `detail_customer`
  ADD CONSTRAINT `detail_customer_ibfk_1` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id`);
