                    ...
                    <div class="row">
                        <div class="col-8">
                            <a href="{{ route('transactions.create') }}"
                                class="btn btn-sm btn-primary pull-right"><span class="fas fa-plus"></span> Create New Transaction</a>
                        </div>
                        <div class="col-2">
...
<script type="text/javascript">
    ...
    var columns = [
        ...
        { data: 'transaction_details.length', class: 'text-center', orderable: true },
        { data: 'purches', class: 'text-center', orderable: true },
        { data: 'statusTransaction', class: 'text-center', orderable: true },
        {
