                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" @click="editData({{ $author }})" class="btn btn-warning btn-sm"><span class="fas fa-edit"></span></a>
                                    <a href="#" @click="deleteData({{ $author->id }})" class="btn btn-danger btn-sm"><span class="fas fa-trash"></span></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
