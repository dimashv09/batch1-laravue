...
<body>
    ...
    <div class="container mt-3">
        <a class="btn btn-primary" href="create.php">Add New Pengarang</a>
        <br><br>
        ...
        while($data = mysqli_fetch_array($pengarang)) :
            ...
            echo "<td><a href='edit.php?id_pengarang=$data[id_pengarang]' class='btn btn-info'>Edit</a>
            <a href='delete.php?id_pengarang=$data[id_pengarang]' class='btn btn-danger'>Delete</a></td></tr>";        
        endwhile;
        ?>
        </table>
    </div>
