...
<body>
	 <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
        <div class="container">
                    ...
                    <a class="nav-link" href="../crud_penerbit/index.php">Penerbit</a>
                    <a class="nav-link" href="../crud_pengarang/index.php">Pengarang</a>
                    <a class="nav-link" href="../crud_katalog/index.php">Katalog</a>
        </div>
    </nav>
