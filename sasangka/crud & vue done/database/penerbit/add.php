...
<body>
	<div class="container">
		...
		<h3 class="page__title">Add Penerbit</h3>
		...
		<?php
			...
			if(isset($_POST['Save'])) {
				...
				$result = mysqli_query($connect, "INSERT INTO `penerbits` (`nama_penerbit`, `email`, `telp`, `alamat`) VALUES ('$nama', '$email', '$telp', '$alamat');");
