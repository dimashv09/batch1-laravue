...
<section class="content">
    ...
    <div class="card-body" style="display: block;">
        ...
        <canvas id="pieChart"
            style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 951px;"
            width="792" height="208" class="chartjs-render-monitor"></canvas>
    </div>
    @endsection
    ...
    <script>
        ...
        // Data Bar Chart
        var dataBar = '{!! json_encode($data_bar) !!}'
